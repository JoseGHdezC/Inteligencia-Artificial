...
class Node {
 public:
  Node(const unsigned data = 0, const unsigned child_number = 0, Node* predecesor = nullptr, const double predecesor_cost = 0);
 ...
 private:
  ...
  double predecesor_cost_; // No puede ser unsigned, tiene que ser double
};
